...
// import Card from '../Components/Card';
// import Navbar from '../Components/Navbar';
// import nmp from '../images/neck-massage-pillow-.png';
// import axios from 'axios';
...
//         },
//         theme: {
//           "color": "#121212" // You can change this color
//         }
//       };
//       const razor = new window.Razorpay(options);
//       razor.open();
...
//     <Box>
//       <Navbar />
//       <Stack h={"100vh"} alignItems="center" justifyContent="center" direction={["column", "row"]} backgroundColor="#FFE6E6" color="#121212">
//           <Card amount={50} img={nmp} checkoutHandler={checkoutHandler} onClose={handleCloseCard} />
//       </Stack>
//     </Box>
//   );
...
const Home = () => {
  ...
  const checkoutHandler = async (amount) => {
    try {
      ...
      const options = {
        ...
        image: "https://avatars.githubusercontent.com/u/25058652?v=4",
        order_id: order.id,
        callback_url: "http://www.localhost:5000/api/paymentverification?userId=${userId}",
        prefill: {
          name: "Zenpod",
          email: "zenpod@example.com",
          contact: "9999999999"
  ...
  return (
    <Box>
      {/* <Navbar /> */}
      <Stack paddingTop="1" h={"100vh"} alignItems="center" justifyContent="center" direction={["column", "row"]} backgroundColor="#FFE6E6" color="#121212">
          <Card amount={50} img={nmp} checkoutHandler={checkoutHandler} onClose={handleCloseCard} />
      </Stack>
    </Box>
  );
